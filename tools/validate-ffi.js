...
const RENDERER_STATUS_FUNCTIONS = new Set([
  ...
  'bloom_scene_set_material_texture_handles',
  'bloom_scene_set_material_texture_transform',
  'bloom_scene_set_material_texture_strengths',
