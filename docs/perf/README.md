...
| [002](002-compute-gtao.md) | Compute GTAO + Hi-Z linear-depth pyramid | ~2 days | SSAO 186 ms → ~50 ms | landed (compute port + hierarchical linear-depth pyramid + conditional CS march: SSAO-only 235→29 ms = **8×**, acceptance target met. Default preset 235→129 ms = 1.8×. SSIM visually indistinguishable from baseline) |
