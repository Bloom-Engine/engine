...
impl Renderer {
    ...
    pub(in crate::renderer) fn pt_layered_clearcoat_normal_active(&self) -> bool {
        self.pt_layered
            .clearcoat_normal_records
            .iter()
            .copied()
            .any(PtClearcoatNormalCpu::active)
    }
    ...
    pub(in crate::renderer) fn pt_layered_uv1_active(&self) -> bool {
        self.pt_layered
            ...
            || self
                ...
                .iter()
                .copied()
                .any(PtClearcoatNormalCpu::has_uv1)
            || self
                .pt_layered
                .sheen_texture_records
                .iter()
    ...
    pub(in crate::renderer) fn set_pt_layered_records(
        ...
        clearcoat_normal_records: Option<Vec<PtClearcoatNormalCpu>>,
        ...
        let clearcoat_normal_records = clearcoat_normal_records.unwrap_or_default();
        ...
        debug_assert!(
            clearcoat_normal_records.is_empty() || clearcoat_normal_records.len() == instance_count
        );
        debug_assert!(
        ...
        if self.pt_layered.clearcoat_normal_records != clearcoat_normal_records {
            self.pt_layered.clearcoat_normal_records = clearcoat_normal_records;
            self.pt_layered.clearcoat_normal_dirty =
                !self.pt_layered.clearcoat_normal_records.is_empty();
            self.pt_accum_count = 0;
            self.pt_wrote_frame = false;
        }
