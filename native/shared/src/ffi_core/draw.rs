...
macro_rules! __bloom_ffi_draw {
    () => {
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_line(
            x1: f64,
            y1: f64,
            x2: f64,
            y2: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_rect(
            x: f64,
            y: f64,
            w: f64,
            h: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_rect_lines(
            x: f64,
            y: f64,
            w: f64,
            h: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_circle(
            cx: f64,
            cy: f64,
            radius: f64,
            r: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_circle_lines(
            cx: f64,
            cy: f64,
            radius: f64,
            r: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_triangle(
            x1: f64,
            y1: f64,
            x2: f64,
            y2: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_poly(
            cx: f64,
            cy: f64,
            sides: f64,
            radius: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_text(
            text_ptr: *const u8,
            x: f64,
            y: f64,
            size: f64,
            ...
            $crate::ffi::guard("bloom_draw_text", move || {
                ...
                let mut text_renderer =
                    std::mem::replace(&mut eng.text, $crate::text_renderer::TextRenderer::empty());
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_text_ex(
            font_handle: f64,
            text_ptr: *const u8,
            x: f64,
            y: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_measure_text_ex(
            font_handle: f64,
            text_ptr: *const u8,
            size: f64,
            spacing: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_texture(
            handle: f64,
            x: f64,
            y: f64,
            tint_r: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_begin_mode_2d(
            offset_x: f64,
            offset_y: f64,
            target_x: f64,
            target_y: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_cube(
            x: f64,
            y: f64,
            z: f64,
            w: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_cube_wires(
            x: f64,
            y: f64,
            z: f64,
            w: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_sphere(
            cx: f64,
            cy: f64,
            cz: f64,
            radius: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_sphere_wires(
            cx: f64,
            cy: f64,
            cz: f64,
            radius: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_cylinder(
            x: f64,
            y: f64,
            z: f64,
            radius_top: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_plane(
            cx: f64,
            cy: f64,
            cz: f64,
            w: f64,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_draw_ray(
            origin_x: f64,
            origin_y: f64,
            origin_z: f64,
            dir_x: f64,
