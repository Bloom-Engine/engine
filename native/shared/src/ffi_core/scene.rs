...
macro_rules! __bloom_ffi_scene {
    () => {
        ...
        #[no_mangle]
        pub extern "C" fn bloom_scene_set_trs(
            handle: f64,
            px: f64,
            py: f64,
            pz: f64,
            ...
            $crate::ffi::guard("bloom_scene_update_geometry", move || {
                ...
                for i in 0..nv {
                    ...
                    vertices.push($crate::renderer::Vertex3D {
                        position: [
                            vert_floats[base] as f32,
                            vert_floats[base + 1] as f32,
                            vert_floats[base + 2] as f32,
                        ],
                        normal: [
                            vert_floats[base + 3] as f32,
                            vert_floats[base + 4] as f32,
                            vert_floats[base + 5] as f32,
                        ],
                        color: [
                            vert_floats[base + 6] as f32,
                            vert_floats[base + 7] as f32,
                            vert_floats[base + 8] as f32,
                            vert_floats[base + 9] as f32,
                        ],
        ...
        #[no_mangle]
        pub extern "C" fn bloom_scene_attach_model_lod(
            node_handle: f64,
            model_handle: f64,
            mesh_index: f64,
            lod_index: f64,
            ...
            $crate::ffi::guard("bloom_scene_attach_model_lod", move || {
                ...
                eng.scene.set_lod_geometry_with_secondary_uv(
                    node_handle,
                    lod_index as usize,
                    vertices,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_scene_set_material_pbr(
            handle: f64,
            roughness: f64,
            metalness: f64,
        ) -> f64 {
        ...
        #[no_mangle]
        pub extern "C" fn bloom_scene_pick_all(
            screen_x: f64,
            screen_y: f64,
            max_results: f64,
        ) -> f64 {
            $crate::ffi::guard("bloom_scene_pick_all", move || {
                ...
                let results = $crate::picking::raycast_scene_all(
                    &eng.scene,
                    &origin,
                    &direction,
        ...
        #[no_mangle]
        pub extern "C" fn bloom_scene_set_material_water(
            handle: f64,
            wave_amp: f64,
            wave_speed: f64,
            r: f64,
        ...
        pub extern "C" fn bloom_scene_get_bounds_min_x(handle: f64) -> f64 {
            $crate::ffi::guard("bloom_scene_get_bounds_min_x", move || {
        ...
        pub extern "C" fn bloom_scene_get_bounds_min_y(handle: f64) -> f64 {
            $crate::ffi::guard("bloom_scene_get_bounds_min_y", move || {
        ...
        pub extern "C" fn bloom_scene_get_bounds_min_z(handle: f64) -> f64 {
            $crate::ffi::guard("bloom_scene_get_bounds_min_z", move || {
        ...
        pub extern "C" fn bloom_scene_get_bounds_max_x(handle: f64) -> f64 {
            $crate::ffi::guard("bloom_scene_get_bounds_max_x", move || {
        ...
        pub extern "C" fn bloom_scene_get_bounds_max_y(handle: f64) -> f64 {
            $crate::ffi::guard("bloom_scene_get_bounds_max_y", move || {
        ...
        pub extern "C" fn bloom_scene_get_bounds_max_z(handle: f64) -> f64 {
            $crate::ffi::guard("bloom_scene_get_bounds_max_z", move || {
        ...
        pub extern "C" fn bloom_scene_extrude_polygon(
            ...
            $crate::ffi::guard("bloom_scene_extrude_polygon", move || {
                ...
                engine()
                    .scene
                    .update_geometry(handle, geo.vertices, geo.indices);
            })
        }
        ...
        #[cfg(feature = "models3d")]
        #[no_mangle]
        pub extern "C" fn bloom_scene_attach_model(
            node_handle: f64,
            model_handle: f64,
            mesh_index: f64,
        ) {
        ...
        pub extern "C" fn bloom_project_screen_y() -> f64 {
            $crate::ffi::guard("bloom_project_screen_y", move || engine().last_project.1)
        }
