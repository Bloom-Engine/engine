...
#[wasm_bindgen]
pub fn bloom_set_chromatic_aberration(strength: f64) {
    engine().renderer.set_chromatic_aberration(strength as f32);
}
#[wasm_bindgen]
pub fn bloom_set_vignette(strength: f64, softness: f64) {
    engine()
        .renderer
        .set_vignette(strength as f32, softness as f32);
}
#[wasm_bindgen]
pub fn bloom_set_film_grain(strength: f64) {
...
#[wasm_bindgen]
pub fn bloom_set_auto_exposure(on: f64) {
    engine().renderer.set_auto_exposure(on != 0.0);
}
#[wasm_bindgen]
pub fn bloom_set_manual_exposure(value: f64) {
    engine().renderer.set_manual_exposure(value as f32);
}
#[wasm_bindgen]
pub fn bloom_set_taa_enabled(on: f64) {
...
#[wasm_bindgen]
pub fn bloom_set_render_scale(scale: f64) {
...
#[wasm_bindgen]
pub fn bloom_set_upscale_mode(mode: f64) {
    engine().renderer.set_upscale_mode(mode as u32);
}
#[wasm_bindgen]
pub fn bloom_set_cas_strength(strength: f64) {
...
#[wasm_bindgen]
pub fn bloom_set_env_intensity(intensity: f64) {
    engine().renderer.set_env_intensity(intensity as f32);
}
#[wasm_bindgen]
pub fn bloom_set_ssgi_enabled(enabled: f64) {
    engine().renderer.set_ssgi_enabled(enabled != 0.0);
}
#[wasm_bindgen]
pub fn bloom_set_ssgi_intensity(intensity: f64) {
    engine().renderer.set_ssgi_intensity(intensity as f32);
}
#[wasm_bindgen]
pub fn bloom_set_ssgi_radius(radius: f64) {
